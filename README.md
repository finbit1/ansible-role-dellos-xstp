...
| ``intf.<interface name>.stp_type`` | list: mstp,rstp | Configures the type of spanning-tree settings on an interface | dellos9 |
...
| ``intf.<interface name>.cost``| integer | Configures cost for RSTP. range 1-2000000 | dellos9,dellos10 |
| ``intf.<interface name>.priority``| integer | Configures priority for RSTP. Range 0-224 | dellos9, dellos10 |
